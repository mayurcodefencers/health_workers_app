  ...
  return Padding(
    ...
    child: Column(
      ...
      child: Row(
        ...
        controller.selectedValueDepartment!.value != "" ? Text(
          doctor,
          style: AppTextStyle.mediumText.copyWith(
              color: AppColor.navyBlueColor,
              fontSize: 14
            ...
            return GestureDetector(
              onTap: () {
                ...
                print("snjndjfnjdnj ${
                    ...
                    controller.timeScheduleModel.value.timeschedule?.first.morningShift?? "11" :
        ...
        controller.storeDoctorPrice!.value != '' ? Row(
